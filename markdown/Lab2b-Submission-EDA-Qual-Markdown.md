...
```
    ...
    ## [1] "Stemmed: teacher"
    ## 
    ## [1] "Original: good at teaching"
    ## [1] "Stemmed: good"  "Stemmed: "      "Stemmed: teach"
    ## 
    ## [1] "Original: the teaching is very detailed"
    ## [1] "Stemmed: "         "Stemmed: teaching" "Stemmed: "        
    ## [4] "Stemmed: "         "Stemmed: detail"
...
```
    ...
    ##  [1] "the"        "lecturer"   "tries"      "as"         "much"      
    ##  [6] "as"         "possible"   "to"         "ensure"     "we"        
    ## [11] "understand"
...
```
    ...
    ## [1] "The lecturer tries as much as possible to ensure we understand."
